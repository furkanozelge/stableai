...
const App = () => {
  ...
  const images3 = [
    ...
    'https://magazine.artland.com/wp-content/uploads/2023/01/ai-future-creativity.jpg',
  ...
  return (
    <ChakraProvider>
      ...
      <Heading size={"2xl"}>Text To Image!</Heading>

      <Box width="100%" height="25vh" display="flex" justifyContent="center" alignItems="center">
           <Box
            borderRadius={"25px"}
            width="280px"
            mr={3}
          ...
          <Wrap marginBottom={"10px"}>
            <Input
              ...
              width={"350px"}
            ></Input>
            <Button onClick={(e) => generate(prompt)} colorScheme={"blackAlpha"}>
              Generate
            </Button>
          </Wrap>
          ...
          {loading ? (
            <Stack mt={6}>
              <Text fontSize={"xl"} color={"black"}>Loading...</Text>
              <SkeletonCircle />
              <SkeletonText />
            </Stack>
          ) : image ? (
